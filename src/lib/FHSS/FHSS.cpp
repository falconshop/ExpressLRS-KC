...
const fhss_config_t domainsDualBand[] = {
    {
        ...
        "KC2G4",
    #endif
    // falconshop KC: Korea 2.4GHz band restriction on the LR1121 2.4 side too, so
    // XR (dual-band) receivers hop the same KC channels as a 2.4-only KC transmitter.
    FREQ_HZ_TO_REG_VAL(2420400000), FREQ_HZ_TO_REG_VAL(2479400000), 60, 2440000000}
};
#endif
...
const fhss_config_t domains[] = {
    {
        ...
        "KC2G4",
    #endif
    // falconshop KC: Korea 2.4GHz band restriction (2420.4-2479.4 MHz, 60 ch)
    FREQ_HZ_TO_REG_VAL(2420400000), FREQ_HZ_TO_REG_VAL(2479400000), 60, 2440000000}
};
#endif
